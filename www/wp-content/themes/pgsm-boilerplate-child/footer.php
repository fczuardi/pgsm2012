    ...
    <![endif]-->
      ...
      <h2 class="fn org"><?php _e('Pós-graduação em Saúde Mental', 'pgsm-boilerplate-child');?> &nbsp;:&nbsp;
        <?php _e('Depto. de Neurociências e Ciências do Comportamento da Faculdade de Medicina de Ribeirão Preto', 'pgsm-boilerplate-child');?> &nbsp;:&nbsp; USP</h2>
      <p class="adr">
        ...
        <?php _e('CEP', 'pgsm-boilerplate-child');?> <span class="postal-code">14051-140</span><br>
        <?php _e('Tel', 'pgsm-boilerplate-child');?>: <a class="tel" href="tel:+55-16-36024607">+55 (16) 3602.4607</a> &nbsp;:&nbsp;
        <?php _e('Fax', 'pgsm-boilerplate-child');?>: <a class="tel" href="tel:+55-16-36024605">+55 (16) 3602.4605</a> &nbsp;:&nbsp;
